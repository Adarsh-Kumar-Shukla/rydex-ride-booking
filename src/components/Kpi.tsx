    ...
    >
      ...
      <div className="relative z-10">
        <motion.div
          ...
          className={`h-11 w-11 rounded-xl flex items-center justify-center ${cfg.iconBg} ${cfg.iconColor}`}
        >
          {icon}
        </motion.div>
        <p className="text-xs font-semibold uppercase tracking-widset text-gray-400 mt-1">
          {label}
        </p>
        <motion.div
