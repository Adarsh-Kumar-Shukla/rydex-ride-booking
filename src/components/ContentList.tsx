  ...
  if (data?.length == 0) {
    return (
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="bg-white rounded-2xl py-16 text-center border-dashed border-gray-200 shadow-sm"
      >
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <p className="font-bold text-sm text-gray-900 trancate">
                  {name}
                </p>
                <p className="text-xs text-gray-400 trancate">{email}</p>
              </div>
            </div>
