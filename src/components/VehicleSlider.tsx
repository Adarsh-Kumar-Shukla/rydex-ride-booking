...
const VEHICLE_CATEGORIES=[
  ...
  {title:"Bikes", desc:"Fast & affordable rides", Icon:Bike, tag:"Quike"},
  {title:"Cars", desc:"Comfortable city travel", Icon:Car, tag:"Comfort"},
  {title:"SUVs", desc:"Prmium & Spacious", Icon:Car, tag:"Premium"},
  {title:"Vans", desc:"Family & group Transport", Icon:Bus, tag:"Family"},
  {title:"Trucks", desc:"Haevy & commercail transport", Icon:Truck, tag:"Cargo"},
]
  ...
  return (
    <div className='w-full bg-white py-20 px-4 overflow-hidden'>
        ...
        >
          ...
          <div className='hidden sm:flex items-center gap-2'>
            <motion.div
              ...
              whileTap={{scale:0.88}}
              className='w-11 h-11 rounded-2xl border border-zinc-200 bg-white flex items-center justify-center hover:bg-zinc-900 hover:border-zinc-900 hover:text-white disabled:opacity-25 disabled:hover:bg-white disabled:hover:text-zinc-900 disabled:border-zinc-200 transition-all text-zinc-700 shadow-sm'
            >
      ...
      <div className='relative'>
        <div 
        ref={sliderRef}
        className='flex gap-5 pt-5 overflow-x-auto scroll-smooth pb-4 px-1'
                ...
                >
                  <motion.div
                    animate={{
                      ...
                      boxShadow: isHovered 
                      ? "0 24px rgba(0,0,0,0.2)"
                      : "0 2px 16px rgba(0,0,0,0.6)",
                    }}
                    transition={{duration: 0.25}}
                    className='relative rounded-3xl border p-3 sm:p-7 overflow-hidden h-full'
                  >
                    <motion.div
                      animate={{
                    ...
                    className='w-14 h-14 rounded flex items-center justify-center mb-5 transition-colors'
                    >
                    ...
                    <motion.p
                      ...
                      transition={{duration:0.2}}
                      className='text-xs front-medium leading-relaxed'
                    >
                      {c.desc}
                    </motion.p>
                  </motion.div>
      ...
      className='flex items-center gap-6 border-t border-zinc-100'
      >
        {
          [
