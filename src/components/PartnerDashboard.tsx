...
const PartnerDashboard = () => {
  ...
  useEffect(()=>{
    if(userData){
      setActiveStep(userData.partnerOnBoardingSteps ? userData.partnerOnBoardingSteps+1 : 0)
    }
  },[userData])
  ...
  const progressPercentage=activeStep===0 ? 0 : ((activeStep-1)/(TOTAL_STEP-1))*100;
  return (
