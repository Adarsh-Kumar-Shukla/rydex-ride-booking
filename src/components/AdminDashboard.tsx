    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200'>
      ...
      <main className='max-w-7xl mx-auto px-6 py-12 space-y-16'>
        <div className='grid grid-cols-2 sm:grid-cols-4 gap-6'>
          ...
          <Kpi label="Approved Partners" value={stats?.totalApprovedPartner} icon={<CheckCircle/>} variant={"approved"}/>
          <Kpi label="Pending Partners" value={stats?.totalPendingPartner} icon={<Clock/>} variant={"pending"}/>
          <Kpi label="Rejected Partners" value={stats?.totalRejectedPartner} icon={<XCircle />} variant={"rejected"}/>
        </div>
        <div className='bg-white rounded-2xl p-2 shadow-gray-100 flex flex-wrap gap-2'>
          <TabButton 
