...
const page = () => {
  ...
  const [pickUpSuggesions, setPickUpSuggesions]=useState<Place[]>([])
  const [dropSuggesions, setDropSuggesions]=useState<Place[]>([])
  ...
  const searchAddress=async (q:string, setResult:(r:Place[])=>void, restrict?:string | null)=>{
    try {
  ...
  const suggestions=(p:Place)=>[p.name, p.city, p.state, p.country].filter(Boolean).join(",")

  const VEHICLES = [
    { id: "bike", label: "Bike", Icon: Bike, desc: "Quick & affordable" },
    { id: "auto", label: "Autodd", Icon: Car, desc: "Everyday rides" },
    { id: "car", label: "Car", Icon: Car, desc: "Confort ride" },
  ...
  return (
    <div className="min-h-screen bg-zinc-100 flex items-center justify-center px-4 py-10">
      ...
      >
        ...
        <div className="bg-white rounded-3xl border-zinc-200 shadow-[0_8px_40px_rgba(0,0,0,0.8)] overflow-visible">
          ...
          <div className="p-6 space-y-7">
                ...
                {VEHICLES.map((v, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`relative p-3.5 rounded-2xl border flex items-center gap-3 text-left transition-all duration-200 ${active ? "bg-zinc-900 shadow-lg" : "bg-zinc-50 border-zinc-900 hover:border-zinc-400"}`}
                    >
                      <div
                  ...
                  <div className="relative z-30">
                    <div className="flex items-center gap-3 px-4 py-3.5 focus-within:bg-white rounded-t-2xl transition-colors">
                      ...
                      onChange={(e)=>{
                        ...
                        searchAddress(e.target.value, setPickUpSuggesions)
                      }}
                      value={pickUp}
                      placeholder="Pickup Location"
                      className="flex-1 bg-transition text-sm font-semibold text-zinc-900 placeholder:text-zinc-400 outline-none"
                      />
                      <motion.button
                      whileTap={{scale:0.88}}
                          ...
                          >
                            {
                              pickUpSuggesions.map((p,i)=>(
                                ...
                                >
                                  ...
                                  <span className="text-sm text-zinc-800 font-medium truncate">{suggestions(p)}</span>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 px-4 py-3.5 focus-within:bg-white rounded-t-2xl transition-colors">
                      ...
                      onChange={(e)=>{
                        ...
                        searchAddress(e.target.value, setDropSuggesions, pickUpCountry)
            ...
            >
              ...
              className="w-full h-14 rounded-2xl bg-zinc-900 hover:bg-black disabled:bg-zinc-400 text-white font-black text-sm tracking-wide flex items-center justify-center gap-2.5 transition-colors shadow-lg disabled:shadow-none"
              onClick={()=>{
